...
<div class="right-sec bg-white">
  <div class="edt-wrap">
    <h3 class="page-header text-center"><b>Purchase Culture Buff Games</b></h3>
  <div class="row">
   <div class="col-md-12"> 
                ...
                <div class="row topsapce3">
                    ...
                    {{$value->licence_type}}
                        ...
                        if($user_type == 2){ ?>
                                ...
                                <div class="col-md-2 col-sm-4"><input data-value1="1" type="number" onkeydown="return false" data-licenceid="{{$value->licence_id}}" @if($key == 0) value="1" @else value="1" @endif    min="0" max="10" class="numberoflinces lid_{{$value->licence_id}}" data-id="gameid" name="numberoflicence[{{$value->licence_id}}]"></div>

                            <?php } else {
                                ?>
                                <div class="col-md-2 col-sm-4"><input data-value1="1" type="text" readonly="readonly" onkeydown="return false" data-licenceid="{{$value->licence_id}}" value="1" class="numberoflinces lid_{{$value->licence_id}}" data-id="gameid" name="numberoflicence[{{$value->licence_id}}]"></div>

                                <?php } ?>

                                <div class="col-md-4 col-sm-4 pricebox_{{$value->licence_id}} priceboxwidth_currency">&pound; <span class="price"> 0 </span></div><!--@if($key == 0) {{$value->licence_price}} @else 0 @endif </span></div>-->
