...
<head>
    ...
    <title>Culture Buff Games Login</title>
...
<div class="container-fluid">
      ...
      <form class="login-form login" action="" method="post">
        ...
        <div class="login-wrap">
          ...
          @endif 
            ...
            <label class="checkbox">
                ...
                <span class="pull-right"> <a href="{{url('resetpassword')}}" class="showforgot"> Forgot Password?</a></span>
            </label>
