...
$(".col-md-6").on('click', '.imgFlip', function(){	
	...
	function displayFinalSlide(){
		$("#main-page").empty();
		$("#main-page").append('    <main><div class="container"><div class="wrapper clearfix"><div class="total-score"><div class="top-logo"><img src="images/big-cartoon.jpg"></div><div class="score-content"><h4>Congratulations you have finished <br>Cultural Buff Britain game.</h4><ul><li><p>Your total score is <span> '+ score + '/104</span></p></li><li>Do you want to try again ?</li></ul> <a href="game1/instructions.html" class="btn button restartbtn"> Restart Game </a>   <a href="game1/main-screen.html" class="btn button exit"> Exit</a> </div></div> </div></div> </main>');
