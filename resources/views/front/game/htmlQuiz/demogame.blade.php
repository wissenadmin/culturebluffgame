<html>
    <head>
        ...
        <script src="{{url('/resources/views/front/game/htmlQuiz')}}/js/controller_demo_game.js"></script>
    ...
    <body>
        ...
        <div id="main-page" class="firstdiv" >
          
                    <header>
            <div class="top-heading">
              <h1>Culture Buff Britain <br>TRIAL GAME</h1>
            </div>
            </header>
            <main>
            <div class="container">
