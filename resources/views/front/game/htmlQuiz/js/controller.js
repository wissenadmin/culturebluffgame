...
lastQuestionAnswered = 0;
 		...
 		$.getJSON('http://181.224.157.105/~hirepeop/host1/codebackup/resources/views/front/game/htmlQuiz/activity.json', function(data) {
...
if(isPrev == true){
	for (var i = 1; i <= 4; i++) {
			...
			if(rnd != i){				
				...
				s = s + '<div id="' + i + '" class="option">' + qOpt + '<img src="http://britishgame.projectstatus.in/resources/views/front/game/htmlQuiz/right-icon.png"></div>';
			}
	}
	flip = '<img class="imgFlip" src="http://britishgame.projectstatus.in/resources/views/front/game/htmlQuiz/images/rotate-img.png">';
}else{
...
for (var i = 1; i <= star; i++) {
	str = str + '<li><img src="http://britishgame.projectstatus.in/resources/views/front/game/htmlQuiz/star_gold_256.png"></li>';
}
...
$(".ques-box").append(s);
$(".col-md-6").empty();
$(".col-md-6").append('<div class="image"><div class="box-shad"><div class="img-box"><div id="f1_container"><div id="f1_card" class="shadow"><div class="front face"><img width="" height="" src="http://britishgame.projectstatus.in/resources/views/front/game/htmlQuiz/images/GAME1/'+questionBank[questionNumber][5]+'"> </div><div class="back face center">  <p>'+questionBank[questionNumber][6]+'</p> </div></div> </div> </div></div><div class="flip-front">'+ flip +'</div></div>');
...
$('.option').click(function(){
 ...
 //  $(this).remove(".w");
   $(".next").remove();
   $(this).append('<img src="http://britishgame.projectstatus.in/resources/views/front/game/htmlQuiz/right-icon.png">');
  ...
  //	alert("hi");
		...
		$(".flip-front").append('<img class="imgFlip" src="http://britishgame.projectstatus.in/resources/views/front/game/htmlQuiz/images/rotate-img.png">');
		playSound("swirl.wav");
	}, 1000); 
  ...
  if(this.id!=rnd){
  	$(this).addClass("wrong");
  	$(this).append('<img src="http://britishgame.projectstatus.in/resources/views/front/game/htmlQuiz/wrong-icon.png" class="w">');
   playSound("wrong.wav");
  }
...
$(".col-md-6").on('click', '.imgFlip', function(){	
	...
	function displayFinalSlide(){
		$(".game1play").empty();
		$(".game1play").append('    <main><div class="container"><div class="wrapper clearfix"><div class="total-score"><div class="top-logo"><img src="http://britishgame.projectstatus.in/resources/views/front/game/htmlQuiz/images/big-cartoon.jpg"></div><div class="score-content"><h4>Congratulations you have finished <br>Culture Buff Britain game.</h4><ul><li><p>Your total score is <span> '+ score + '/104</span></p></li><li>Do you want to try again ?</li></ul> <a href="" class="btn button restartbtn"> Restart Game </a>   <a href="" class="btn button exit"> Exit</a> </div></div> </div></div> </main>');
