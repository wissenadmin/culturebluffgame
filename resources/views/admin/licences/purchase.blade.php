...
<div class=" bg-white">
  ...
  <div class="row">
   ...
   <div class="col-md-12"> 
    ...
    <form class="british-game-popup" enctype="multipart/form-data" class="reset-pass clearfix" id="trialrequestform" method="post" >
     ...
     <!--  <input type="hidden" name="no_note" value="1" /> -->
      ...
      <div class="finalprice   row topsapce2"><div class="col-md-12  text-center "><h1>Total Price (GBP) : <span class="finlprice"></span></h1></div> </div>

      <div class="topsapce5 text-center topsapce1">
