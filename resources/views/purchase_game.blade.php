<link rel="stylesheet" href="{{url()}}/resources/admin-html/assets/css/ebro_multi-select.css" type="text/css" />
<link rel="stylesheet" href="{{url()}}/resources/admin-html/assets/css/multi-select.css" type="text/css" />

<script type="text/javascript" src="{{url()}}/resources/admin-html/assets/js/jquery.multi-select.js"></script>
<div class=" bg-white">
  <div class="edt-wrap">
   ...
   <div class="col-md-12"> 
    ...
    <form enctype="multipart/form-data" class="reset-pass clearfix" id="trialrequestform" method="post" >
       ...
       <div class="form-group">
        ...
        <select  multiple="multiple" name="licenceType" class="form-control licenceType" required="required">
      ...
      <div class="form-group">
        ...
        <input type="number" onkeydown="return false"   name="numberoflicence" value="1" class="form-control number_of_licence" required="" min="1">
      </div>
      @else
      <input type="hidden" onkeydown="return false" name="numberoflicence" value="1" class="form-control number_of_licence" required="" min="1">
      @endif
      <?php //$payment =  ?> 
      <div class="form-group">
