...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Login Page - Culture Buff Games Admin</title>
        ...
        <!-- ace styles -->
        <link rel="stylesheet" href="{{url('/resources/admin-html')}}/assets/css/ace.min.css" />

        <!--[if lte IE 9]>
            <link rel="stylesheet" href="{{url('/resources/admin-html')}}/assets/css/ace-part2.min.css" />
        <![endif]-->
        <link rel="stylesheet" href="{{url('/resources/admin-html')}}/assets/css/ace-rtl.min.css" />
                        ...
                        <div class="login-container">
                            <div class="center">
                                <h1>
                                    ...
                                    <span class="red">Culture Buff Games</span>
                                ...
                                <div id="login-box" class="login-box visible widget-box no-border">
                                    ...
                                    <div class="widget-body">
                                        ...
                                        @endif
                                            ...
                                            <form method="post" class="m-t" role="form" action="{{url('admin/login')}}">
...
<![endif]-->
        ...
        var url = "{{url('/resources/admin-html')}}/";
            window.jQuery || document.write("<script src='http://localhost/britishgame/resources/admin-html/assets/js/jquery.min.js'>"+"<"+"/script>");
        </script>
...
<![endif]-->
        <script type="text/javascript">
        var url = "{{url('/resources/admin-html')}}/";
            if('ontouchstart' in document.documentElement) document.write("<script src='http://localhost/britishgame/resources/admin-html//assets/js/jquery.mobile.custom.min.js'>"+"<"+"/script>");
        </script>
