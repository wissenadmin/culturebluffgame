...
<font size="3" color="#333" face="verdana">Please visit our website at <a href="www.culturebuffgames.com">www.culturebuffgames.com </a> and click on the <b>myCultureBuff</b> button to access your purchased games. </font><br><br><br>

<font size="3" color="" face="verdana" style="" class="test"><b><span style="color:#1155CC;">Username</span> 	{{$data['user_username']}} <br>
<span style="color:#1155CC;">Password</span> {{$data['org_password']}}</b></font>

<br><br>
<font size="3" color="#333" face="verdana"> The following games were purchased by you: </font>
<br>
<font size="3" color="#333" face="verdana">
@foreach($data['games_info'] as $key => $value)
<b>{{$value['game_licence']}}</b> <br>
 <i> Your license will expire on <b> {{changeDateFormat($value['licence_valid_till'])}}. </b> </i><br><br>
@endforeach
</font>

<br>
<font size="3" color="#000" face="verdana">Please contact us at techsupport@culturebuffgames.com for any technical assistance with accessing the games.</font><br><br>
